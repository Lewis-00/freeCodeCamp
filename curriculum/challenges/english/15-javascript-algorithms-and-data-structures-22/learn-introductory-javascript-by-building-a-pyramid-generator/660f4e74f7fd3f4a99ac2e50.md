...
Directly below your `numbers` array, declare a `shifted` constant and assign it the result of calling `.shift()` on the `numbers` array. On the next line, log the `shifted` variable to the console.
